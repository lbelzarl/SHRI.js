;(function() {
    $('.load-mentors').on('click', function() {
        ...
        // Удаляем всех менторов у всех студентов
        SHRI.Students.emptyAllMentors(mentors);

        // Случайно составляем списки менторов и студентов
    ...
    function renderLines(mentors, students) {
        ...
        // Выводит список менторов с указанием интересующих их студентов
        ...
        // Выводит список студентов с указанием интересующих их менторов
    ...
    // Динамически выводит менторов и их студентов
